            ...
            if( !options.templateUrl ){
                ...
                if( options.basic ){
                    ...
                    html = '<div class="ui small modal"> <i class="close icon" ng-click="close(false)"></i> <div class="header">' +
                        ' {{title}}' +
                        ' </div>' +
                        ' <div class="content"> <div class="description"> <p ng-show="text">{{text}}</p>' + content + ' </div> </div> <div class="actions"> <div class="ui black deny button" ng-click="close(false)" ng-show="negative"> {{negative}} </div> <div class="ui positive right labeled icon button" ng-click="close(true)" ng-class="{disabled:  ' + options.positiveDisable + '}" ng-show="positive"> {{positive}} <i class="checkmark icon"></i> </div> </div> </div>';
                }
